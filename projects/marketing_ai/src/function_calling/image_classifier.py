...
def get_image_template(
    user_prompt: str, classification: str, shall_have_text: bool = True
) -> str:
    """
...
def classify_text(text: str) -> str:
    ...
    # Use gpt to classify
    gpt_str = (
        'Classify this text into one of three categories: meme, propaganda, marketing. "'
        + text
        + '". Response should be one of the three categories.'
    )
...
llm = OpenAI(temperature=0, openai_api_key=get_config().API_KEY, model="davinci-002")
